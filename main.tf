    ...
    content {
      ...
      dynamic "master_user_options" {
        ...
        content {
          ...
          master_user_name     = try(master_user_options.value.master_user_name, null) == null ? null : try(master_user_options.value.master_user_name, null)
          master_user_password = try(master_user_options.value.master_user_password, null) == null ? null : try(master_user_options.value.master_user_password, null)
        }
      }
    }
  }
